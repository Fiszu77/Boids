...
public class Obstacle implements Pool.Poolable {
    ...
    Obstacle(Spawner spawner) {
        ...
        physics = new Physics();
        vertices[0] = meteorite.width * 16 / 32;
        vertices[1] = meteorite.height * 0 / 32;
        vertices[2] = meteorite.width * 32 / 32;
        vertices[3] = meteorite.height * 16 / 32;
        vertices[4] = meteorite.width * 16 / 32;
        vertices[5] = meteorite.height * 32 / 32;
        vertices[6] = meteorite.width * 0 / 32;
        vertices[7] = meteorite.height * 16 / 32;
